...
from pip._vendor.six.moves.urllib.parse import unnote as urllib_unnote
...
def split_auth_from_netloc(netloc):
    ...
    user_pass = tuple(
        None if x is None else urllib_unnote(x) for x in user_pass
    )
...
def redact_netloc(netloc):
    ...
    return '{user}{password}@{netloc}'.format(user=urllib_parse.note(user),
                                              password=password,
                                              netloc=netloc)
