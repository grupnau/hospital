...
# This denote() business is required for some older versions
# of mysql_config
...
def get_config():
    ...
    library_dirs = [denote(i[2:]) for i in libs if i.startswith('-L')]
    libraries = [denote(i[2:]) for i in libs if i.startswith('-l')]
